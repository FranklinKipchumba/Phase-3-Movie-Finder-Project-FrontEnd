...
function Signup({ addNewUser }) {
    ...
    return (
        <div class = "signup-box">
            <h2><b>Signup</b></h2>
            <br></br>
            <h3><b>Welcome to Movie App</b></h3>
            <br></br>
            <h4> <i>Signup access movies from anywhere </i></h4>
            <br></br>
            <form  className = 'formWrapper' onSubmit = {handleSubmit} autoComplete="off">
            <div class = "user-box">
                <label className = 'label' htmlFor = 'username'></label>
                <input className = 'input' id = 'username' type = 'text' name = 'user_name' placeholder = 'User_name' value = {formState.user_name} onChange = {formChange} required />
            </div>
            <br></br>
            <div class = "user-box">  
